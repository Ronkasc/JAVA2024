...
public class BigIntegerCalculator {
    ...
    public BigIntegerCalculator(String number) {
        if (!number.matches("\\d+")) {
            throw new IllegalArgumentException("Ввод содержит нечисловые символы");
        }
    ...
    public static void main(String[] args) {
        BigIntegerCalculator num1 = new BigIntegerCalculator("0398457349875");
        BigIntegerCalculator num2 = new BigIntegerCalculator("9345533210");

        System.out.println("сложение: " + num1.add(num2));
        System.out.println("Вычитание: " + num2.subtract(num1));
